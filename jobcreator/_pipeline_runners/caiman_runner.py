...
def parse_args():
    parser = argparse.ArgumentParser(description='CaImAn parameters')
    parser.add_argument('--file', default=[], type=list, help='options')
...
# %% First setup some parameters for motion correction
    ...
    fnames = files  # filename to be processed
    #fnames = [fnames]  # download file if not already present
